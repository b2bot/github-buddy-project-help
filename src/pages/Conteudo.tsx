...
import { Bold, Italic, List, ListOrdered, Quote, Code, Image as ImageIcon, Sparkles, AlertCircle, RefreshCw, Calendar, PenTool, Download, Wand2 } from "lucide-react";
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-bold">✍️ Escrever Conteúdo</h1>
              ...
              <div className="lg:col-span-3">
                <Card className="bg-card/50 backdrop-blur-sm border border-border/50">
                  <CardContent className="p-6">
                    ...
                    <EditorContent 
                      editor={editor}
                      className="border rounded-lg min-h-[500px] bg-background focus-within:ring-2 focus-within:ring-primary/20 transition-all"
                    />
                  </CardContent>
                </Card>
              </div>
